...
class RobustVideoSteganography:
    ...
    def extract_frames_ffmpeg(self, video_path: str, output_dir: str) -> List[str]:
        ...
        ffmpeg_path = r'C:\Users\Admin\ffmpeg-master-latest-win64-gpl-shared\ffmpeg-master-latest-win64-gpl-shared\bin\ffmpeg.exe'
        cmd = [
    ...
    def get_video_info(self, video_path: str) -> dict:
        ...
        """
        ffprobe_path = r'C:\Users\Admin\ffmpeg-master-latest-win64-gpl-shared\ffmpeg-master-latest-win64-gpl-shared\bin\ffprobe.exe'
        cmd = [
